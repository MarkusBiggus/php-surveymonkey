...
//        curl_setopt($this->conn, CURLOPT_SSL_VERIFYPEER, false); // don't check SSL cert
        curl_setopt($this->conn, CURLOPT_CAINFO, $ca); // Set the location of the CA-bundle - use line above if you don't have this package
